...
function InsertCreditCard() {
	return (
		<div className="h-fit w-full">
			<div className="header w-full flex  items-center flex-col pt-1 justify-center bg-[#005CA9] text-[#fff] border rounded-b-xl h-11">
				<p className="font-semibold">CRÉDITO</p>
			</div>
			<div className="w-4/5 pt-11">
				...
				<div className="pt-3 wfull">
					<fieldset className="w-full">
						...
						<input
							type="text"
							className="border border-[#BDC3C7] w-full mb-4"
						/>
						<legend className="text-[#2D3436] font-normal mb-1 text-xs">
							Nº DO CARTÃO
						</legend>
					...
					<fieldset className="flex">
						<legend className="text-[#2D3436] font-normal mb-1 w-2/4 text-xs">
							DATA DE VENCIMENTO
						</legend>
						...
						<input
							type="number"
							className="border border-[#BDC3C7] mb-4 w-fit"
						/>
					</fieldset>
				</div>
